...
app.get('/tambdi',function(req,res){
	res.render('tambdi');
});

app.get('/safa',function(req,res){
	res.render('safa');
});
app.get('/bacillica',function(req,res){
	res.render('bacillica');
});

app.get('/bodgeshwar',function(req,res){
	res.render('bodgeshwar');
});

app.get('/baga',function(req,res){
	res.render('baga');
});

app.get('/aguada',function(req,res){
	res.render('aguada');
});

app.get('/ambedkar',function(req,res){
	res.render('ambedkar');
});

app.get('/dudhsagar',function(req,res){
	res.render('dudhsagar');
});

app.get('/mayem',function(req,res){
	res.render('mayem');
});
...
app.get('/sinquerim',function(req,res){
	res.render('sinquerim');
});
